...
class AppLocalizations {
  ...
  static const Map<String, String> _es = {
    ...
    'round_history': 'Historial de Puntos',
    'round_short': 'R',
    ...
    'benefit_no_ads': 'Elimina todos los anuncios',
    'subscribe_for': 'Suscribirse por %s',
    'per_month': 'al mes · cancela cuando quieras',
    'restore_purchases': 'Restaurar compras',
    'subscription_terms': 'La suscripción se renueva automáticamente cada mes hasta que la canceles desde la tienda. El pago se carga a tu cuenta al confirmar la compra.',
    'iap_unavailable': 'Las compras no están disponibles en este dispositivo.',
    'loading_product': 'Cargando producto...',
    'premium_active': '¡Premium activo!',
    'premium_active_desc': 'Gracias por tu apoyo. Disfruta la app sin anuncios.',
  ...
  static const Map<String, String> _en = {
    ...
    'benefit_no_ads': 'Remove all ads',
    'subscribe_for': 'Subscribe for %s',
    'per_month': 'per month · cancel anytime',
    'restore_purchases': 'Restore purchases',
    'subscription_terms': 'Subscription renews automatically every month until you cancel it from the store. Your account will be charged upon purchase confirmation.',
    'iap_unavailable': 'In-app purchases are not available on this device.',
    'loading_product': 'Loading product...',
    'premium_active': 'Premium active!',
    'premium_active_desc': 'Thanks for your support. Enjoy the app ad-free.',
  ...
  static const Map<String, String> _pt = {
    ...
    'round_history': 'Histórico de Pontos',
    'round_short': 'R',
    ...
    'benefit_no_ads': 'Remova todos os anúncios',
    'subscribe_for': 'Assinar por %s',
    'per_month': 'por mês · cancele quando quiser',
    'restore_purchases': 'Restaurar compras',
    'subscription_terms': 'A assinatura é renovada automaticamente todo mês até que você a cancele na loja. O pagamento será cobrado na sua conta ao confirmar a compra.',
    'iap_unavailable': 'Compras no app não estão disponíveis neste dispositivo.',
    'loading_product': 'Carregando produto...',
    'premium_active': 'Premium ativo!',
    'premium_active_desc': 'Obrigado pelo apoio. Aproveite o app sem anúncios.',
